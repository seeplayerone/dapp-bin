...
import "../pis_main.sol";
import "../pis_main_no_governance.sol";
...
import "../gov_vote_director.sol";
import "../gov_publicity.sol";
...
contract FakePaiDaoNoGovernance is PaiDaoNoGovernance {
    constructor(string _organizationName)
        PaiDaoNoGovernance(_organizationName)
        public
    {
